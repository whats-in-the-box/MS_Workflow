...
```{r upload.file}
fh <- upload.file(raw_data_file, 1) 
...
# Normality check before further processing
...
Please change data processing method `processingMethod` below to change data processing method for downstream analysis:
