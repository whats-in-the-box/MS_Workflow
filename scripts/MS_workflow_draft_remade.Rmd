...
plot_grid(hist_imputed, pca_initial, hist_log2, qq_log2, nrow = 2)
```
...
plot_grid(pca_initial, pca_eigenms, pca_cspline, nrow = 1)
```


```{r, fig.dim = c(10, 5), out.width = "100%"}
plot_grid(hist_log2, hist_eigenms, hist_cspline, nrow = 1)
```


```{r, fig.dim = c(10, 5), out.width = "100%"}
plot_grid(qq_log2, qq_eigenms, qq_cspline, nrow = 1)
```
